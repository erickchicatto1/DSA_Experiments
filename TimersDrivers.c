...
enum Estado {Alto, Movimiento_Adelante , Movimiento_Atras}; // Falta implementar los giros
...
int main(void){
  ...
  enum Estado estadoActual = Alto;

  while (1){
	  switch(estadoActual){

	    case Alto:
	    //Sequence mov to Servomotor;
	    estadoActual = Movimiento_Adelante;
	    break;

	    case Movimiento_Adelante:
	    estadoActual = Movimiento_Atras;
	    break;
